...
<head>
  ...
  <style type="text/css">
    *,body {
    ...
    .logo {
      background-image: url('static/img/logo-griddy.png');
...
<body>
  <header>
    <h1 class="logo">Griddy Sample App</h1>
    <div class="description">
      Get real-time energy prices from Commonwealth Edison
    </div>
  </header>
  <p>          
    <form role="form" id="user" method="POST" action="/prices">
      ...
      <input type="submit" value="Find Price" class="btn btn-default" tabindex="4" /> &nbsp;
      <a href="#" title="don't find price">Cancel</a>
    </form>
  </p>
  <footer>
    <div class="author">
